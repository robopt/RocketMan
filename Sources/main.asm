...
; export symbols
            ...
            XDEF number 
            XDEF ad0_enable, ad0_enableLine, ad0conv, ad0convfast, ad1_enable, ad1conv
...
;   ad1_enable();
ad1_enable:
	          ldaa	#$80	;0b	    ;10-bit resolution  /24 clock
	          staa	ATD1CTL2
	          ldaa #$38
	          staa ATD1CTL3
	          ldaa	#$80		    ;set ADPU & AFFC
...
motor3_init:
            ...
            movb  #00,   PWMDTY3   ;initial duty cycle = 50%
            rts
...
motor7_init:
            ...
            movb  #00,   PWMDTY7   ;initial duty cycle = 50%
            rts
